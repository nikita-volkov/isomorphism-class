...
instance IsomorphicToSubsetOf Data.ByteString.Builder.Builder Data.ByteString.Short.ShortByteString where
  to = Data.ByteString.Builder.shortByteString

instance IsomorphicToSubsetOf Data.ByteString.Short.ShortByteString Data.ByteString.Builder.Builder where
